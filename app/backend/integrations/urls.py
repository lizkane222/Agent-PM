...
urlpatterns = [
    ...
    path("gmail/watch/", GmailWatchView.as_view(), name="gmail-watch"),
    path("gmail/meeting-notes/", MeetingNotesFromEmailView.as_view(), name="gmail-meeting-notes"),
