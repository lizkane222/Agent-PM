...
const NODE_A: CanvasNode = { id: "a", type: "Text", props: {}, children: [] };
const NODE_B: CanvasNode = { id: "b", type: "Icon", props: {}, children: [] };
const NODE_C: CanvasNode = { id: "c", type: "Card", props: {}, children: [] };
...
export const CANVAS_REDUCER_FIXTURES: ReducerFixture[] = [
  {
