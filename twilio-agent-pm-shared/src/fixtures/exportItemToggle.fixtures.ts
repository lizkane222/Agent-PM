...
const ITEM_A: ExportItem = { id: "account:1", type: "account", label: "Acme", summary: "Acme Corp", content: "..." };
const ITEM_B: ExportItem = { id: "action_item:abc", type: "action_item", label: "Fix bug", summary: "Fix the bug", content: "..." };
const ITEM_C: ExportItem = { id: "account:2", type: "account", label: "Beta Inc", summary: "Beta Inc Corp", content: "..." };
...
export const EXPORT_ITEM_TOGGLE_FIXTURES: ExportToggleFixture[] = [
  {
    initialItems: [],
    toggle: ITEM_A,
