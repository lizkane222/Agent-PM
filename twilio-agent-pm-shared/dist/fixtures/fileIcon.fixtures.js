...
export const FILE_ICON_FIXTURES = [
...
export const ATTACH_LINK_ICON_FIXTURES = [
...
export const FMT_BYTES_FIXTURES = [
    { bytes: null, expected: "" },
    { bytes: 0, expected: "" },
...
export const FMT_TIME_FIXTURES = [
...
export const FORMAT_ARR_FIXTURES = [
    { input: null, expected: "—" },
    { input: "", expected: "—" },
...
//# sourceMappingURL=fileIcon.fixtures.js.map