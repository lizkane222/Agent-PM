...
const VALID_PAYLOAD_B64 = btoa(JSON.stringify({ user_id: 42, username: "alice", email: "alice@twilio.com", exp: 9999999999 })).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_");
const EXPIRED_PAYLOAD_B64 = btoa(JSON.stringify({ user_id: 1, username: "bob", exp: 1 })).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_");
...
export const DECODE_JWT_FIXTURES = [
    {
        token: VALID_TOKEN,
...
export const IS_TOKEN_EXPIRED_FIXTURES = [
    {
        token: VALID_TOKEN,
        nowSecs: 1000000000,
        expected: false,
...
//# sourceMappingURL=jwtUtils.fixtures.js.map