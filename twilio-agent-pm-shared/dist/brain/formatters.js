...
export function attachLinkIcon(url) {
    try {
        ...
        if (h === "drive.google.com")
            return "🗂️";
        if (h === "mail.google.com" || h === "gmail.com")
            return "📧";
        if (h === "calendar.google.com")
            return "📅";
        if (h === "sheets.google.com")
            return "📊";
        if (h === "slides.google.com")
            return "🟨";
        if (h === "forms.google.com")
            return "📋";
        if (h === "sites.google.com")
            return "🌐";
        if (h === "notebooklm.google.com")
            return "📓";
        if (h === "gemini.google.com")
            return "✨";
        if (h.endsWith("gong.io"))
            return "🎙️";
        if (h.endsWith("figma.com"))
            return "🎨";
        if (h.endsWith("notion.so"))
            return "📓";
