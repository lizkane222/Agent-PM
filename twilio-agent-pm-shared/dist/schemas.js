import { z } from "zod";
// ── Primitives ────────────────────────────────────────────────────────────────
export const IsoDateStringSchema = z.string().regex(/^\d{4}-\d{2}-\d{2}(T[\d:.Z+-]+)?$/, "Expected ISO date string");
export const IsoDateOnlySchema = z.string().regex(/^\d{4}-\d{2}-\d{2}$/, "Expected YYYY-MM-DD");
// ── Auth ──────────────────────────────────────────────────────────────────────
...
// ── Canvas / Page Builder ─────────────────────────────────────────────────────
export const CanvasNodeSchema = z.lazy(() => z.object({
    id: z.string(),
    type: z.string(),
